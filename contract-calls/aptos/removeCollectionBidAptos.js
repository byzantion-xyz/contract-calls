export const removeCollectionBidAptos = async ({
  bid,
  ...
  const createPayload = () => {
    switch(bid?.market_contract?.name) {
      ...
      case "topaz":
        return {
          function: "0x2c7bccf7b31baf770fdbcc768d9e9cb3d87805e255355df5db32ac9a669010a2::collection_marketplace::cancel",
          type_arguments: [
      ...
      case "souffl3":
        return {
          function: "0x7ee5b48b8b7413d062331f6728652cd9e371f3a173379e5ee30870e8875d2784::offer::cancel_collection_offer",
          type_arguments: [
            "0x1::aptos_coin::AptosCoin"
          ],
          arguments: [
      ...
      case "bluemove":
        return {
          function: "0xd1fd99c1944b84d1670a2536417e997864ad12303d19eac725891691b04d614e::marketplaceV2::cancel_offer_collection",
          type_arguments: [],
          arguments: [
            bid?.nonce,
            "1"
